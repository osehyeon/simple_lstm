...
graph = helper.make_graph(
    ...
    "LSTM_Example",
    [X],
    [helper.make_tensor_value_info('Y_h', onnx.TensorProto.FLOAT, [1, 1, 10])],
    [W, R, B]
)
...
# Save the ONNX model
onnx.save(inferred_model, "lstm-onnx.onnx")

# Load the model and validate by running inference
ort_session = onnxruntime.InferenceSession("lstm-onnx.onnx")
