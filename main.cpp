...
{
    // 가중치 파일의 경로를 가져와 저장함
    char file_W_1_16[] = "../Weight/tensor_W_1_16.txt";
    char file_R_1_16[] = "../Weight/tensor_R_1_16.txt";
    char file_B_1_16[] = "../Weight/tensor_B_1_16.txt";

    char file_W_2_16[] = "../Weight/tensor_W_2_16.txt";
    char file_R_2_16[] = "../Weight/tensor_R_2_16.txt";
    char file_B_2_16[] = "../Weight/tensor_B_2_16.txt";

    char file_W_3_16[] = "../Weight/tensor_W_3_16.txt";
    char file_R_3_16[] = "../Weight/tensor_R_3_16.txt";
    char file_B_3_16[] = "../Weight/tensor_B_3_16.txt";

    char file_W_4_1[] = "../Weight/tensor_W_4_1.txt";
    char file_R_4_1[] = "../Weight/tensor_R_4_1.txt";
    char file_B_4_1[] = "../Weight/tensor_B_4_1.txt";
    ...
    tensor_W_resize(file_W_1_16, tensor_W_1_16, 16);
    tensor_R_resize(file_R_1_16, tensor_R_1_16, 16);
    tensor_B_resize(file_B_1_16, tensor_B_1_16, 16);
    
    tensor_W_resize(file_W_2_16, tensor_W_2_16, 16);
    tensor_R_resize(file_R_2_16, tensor_R_2_16, 16);
    tensor_B_resize(file_B_2_16, tensor_B_2_16, 16);

    tensor_W_resize(file_W_3_16, tensor_W_3_16, 16);
    tensor_R_resize(file_R_3_16, tensor_R_3_16, 16);
    tensor_B_resize(file_B_3_16, tensor_B_3_16, 16);

    tensor_W_resize(file_W_4_1, tensor_W_4_1, 1);
    tensor_R_resize(file_R_4_1, tensor_R_4_1, 1);
    tensor_B_resize(file_B_4_1, tensor_B_4_1, 1);
